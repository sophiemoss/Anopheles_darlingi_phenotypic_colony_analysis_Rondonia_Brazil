...
# %%
working_directory = '/phenotyped_colony'
...
# %%  IMPORT METADATA
df_samples= pd.read_csv('darlingi_resistance_metadata.csv',sep=',',usecols=['sample','pyrethroid_resistance_status'])
df_samples.head()
...
# %% Save Fst values over this threshold as a csv file
