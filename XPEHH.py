...
# %% set wd
os.chdir('/darlingi_database/phenotyped_colony')
os.getcwd()
...
# %%
## import metadata
df_samples=pd.read_csv('/darlingi/darlingi_resistance_metadata.csv',sep=',',usecols=['sample','population','region','country','site','resistance_status'])
df_samples.head()
